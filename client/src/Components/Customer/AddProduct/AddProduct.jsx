...
const addProduct = () => {
  return (
    <Box style={{width : "20rem", display:"flex", justifyContent:"center",  alignContent : "center"}} >
    <form style={{display : "flex", flexDirection: "column", margin:"auto"}} name="addProduct" action="/adminActions/newProduct" method="POST" enctype="multipart/form-data">
